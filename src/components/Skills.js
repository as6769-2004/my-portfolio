...
const Skills = () => {
  ...
  const techIconMap = {
    ...
    'TypeScript': { icon: Code, bgColor: 'bg-blue-600', textColor: 'text-white' },
    'HTML5': { icon: Code, bgColor: 'bg-orange-500', textColor: 'text-white' },
    'CSS3': { icon: Code, bgColor: 'bg-blue-500', textColor: 'text-white' },
    'SASS': { icon: Code, bgColor: 'bg-pink-500', textColor: 'text-white' },
    'Redux': { icon: Code, bgColor: 'bg-purple-500', textColor: 'text-white' },
    'MobX': { icon: Code, bgColor: 'bg-blue-500', textColor: 'text-white' },
    'Jest': { icon: Code, bgColor: 'bg-red-500', textColor: 'text-white' },
    'Cypress': { icon: Code, bgColor: 'bg-green-500', textColor: 'text-white' },
    'Webpack': { icon: Settings, bgColor: 'bg-blue-500', textColor: 'text-white' },
    'Vite': { icon: Code, bgColor: 'bg-purple-500', textColor: 'text-white' },
    'NPM': { icon: Settings, bgColor: 'bg-red-500', textColor: 'text-white' },
    'Yarn': { icon: Settings, bgColor: 'bg-blue-500', textColor: 'text-white' },
    'REST APIs': { icon: Server, bgColor: 'bg-green-500', textColor: 'text-white' },
    'Microservices': { icon: Server, bgColor: 'bg-blue-500', textColor: 'text-white' },
    'JWT': { icon: Settings, bgColor: 'bg-purple-500', textColor: 'text-white' },
    'OAuth': { icon: Settings, bgColor: 'bg-blue-500', textColor: 'text-white' },
    'Socket.io': { icon: Globe, bgColor: 'bg-green-500', textColor: 'text-white' },
    'WebSockets': { icon: Globe, bgColor: 'bg-blue-500', textColor: 'text-white' },
    'REST': { icon: Server, bgColor: 'bg-green-500', textColor: 'text-white' },
    'GraphQL': { icon: Code, bgColor: 'bg-pink-500', textColor: 'text-white' },
    'Apollo': { icon: Code, bgColor: 'bg-purple-500', textColor: 'text-white' },
    'Prisma': { icon: DatabaseIcon, bgColor: 'bg-green-500', textColor: 'text-white' },
    'TypeORM': { icon: DatabaseIcon, bgColor: 'bg-blue-500', textColor: 'text-white' },
    'Redis': { icon: DatabaseIcon, bgColor: 'bg-red-500', textColor: 'text-white' },
    'Elasticsearch': { icon: DatabaseIcon, bgColor: 'bg-yellow-500', textColor: 'text-black' },
    'Heroku': { icon: Cloud, bgColor: 'bg-purple-500', textColor: 'text-white' },
    'DigitalOcean': { icon: Cloud, bgColor: 'bg-blue-500', textColor: 'text-white' },
    'Kubernetes': { icon: Settings, bgColor: 'bg-blue-600', textColor: 'text-white' },
    'Jenkins': { icon: Settings, bgColor: 'bg-red-500', textColor: 'text-white' },
    'GitHub Actions': { icon: Github, bgColor: 'bg-black', textColor: 'text-white' },
    'CircleCI': { icon: Settings, bgColor: 'bg-green-500', textColor: 'text-white' },
  };
